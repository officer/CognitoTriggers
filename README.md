...
This is a sample template for CognitoTriggers - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name cognitotriggers --tail
```
...
```bash
aws cloudformation delete-stack --stack-name cognitotriggers
```
